...
func newNetDir(root *auth.Credentials, inoGen InoGenerator) *kernfs.Dentry {
	return kernfs.NewStaticDir(root, inoGen.NextIno(), 0555, map[string]*kernfs.Dentry{
		"net": kernfs.NewStaticDir(root, inoGen.NextIno(), 0555, map[string]*kernfs.Dentry{
			"ipv4": kernfs.NewStaticDir(root, inoGen.NextIno(), 0555, map[string]*kernfs.Dentry{
				...
				"ip_local_port_range":     kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "16000   65535"}),
				"ip_local_reserved_ports": kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{}),
				"ipfrag_time":             kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "30"}),
				"ip_nonlocal_bind":        kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"ip_no_pmtu_disc":         kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "1"}),

				// tcp_allowed_congestion_control tell the user what they are able to
				// do as an unprivledged process so we leave it empty.
				"tcp_allowed_congestion_control":   kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: ""}),
				"tcp_available_congestion_control": kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "reno"}),
				"tcp_congestion_control":           kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "reno"}),
				...
				// disabled.
				"tcp_base_mss":              kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "1280"}),
				"tcp_dsack":                 kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_early_retrans":         kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_fack":                  kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_fastopen":              kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_fastopen_key":          kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: ""}),
				"tcp_invalid_ratelimit":     kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_keepalive_intvl":       kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_keepalive_probes":      kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_keepalive_time":        kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "7200"}),
				"tcp_mtu_probing":           kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_no_metrics_save":       kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "1"}),
				"tcp_probe_interval":        kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_probe_threshold":       kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"tcp_retries1":              kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "3"}),
				"tcp_retries2":              kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "15"}),
				"tcp_rfc1337":               kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "1"}),
				"tcp_slow_start_after_idle": kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "1"}),
				"tcp_synack_retries":        kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "5"}),
				"tcp_syn_retries":           kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "3"}),
				"tcp_timestamps":            kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "1"}),
			}),
			"core": kernfs.NewStaticDir(root, inoGen.NextIno(), 0555, map[string]*kernfs.Dentry{
				"default_qdisc": kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "pfifo_fast"}),
				"message_burst": kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "10"}),
				"message_cost":  kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "5"}),
				"optmem_max":    kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "0"}),
				"rmem_default":  kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "212992"}),
				"rmem_max":      kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "212992"}),
				"somaxconn":     kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "128"}),
				"wmem_default":  kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "212992"}),
				"wmem_max":      kernfs.NewDynamicBytesFile(root, inoGen.NextIno(), defaultPermission, &vfs.StaticData{Data: "212992"}),
			}),
		}),
	})
}
