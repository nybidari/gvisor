...
var Metrics = tcpip.Stats{
	...
	IP: tcpip.IPStats{
		...
		InvalidSourceAddressesReceived: mustCreateMetric("/netstack/ip/invalid_source_addresses_received", "Total number of IP packets received with a source address that should never have been receieved on the wire."),
