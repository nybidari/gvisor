...
func (i *inodeOperations) SetXattr(ctx context.Context, inode *fs.Inode, name string, value string, size uint64, flags uint32) error {
	return i.fileState.file.setXattr(ctx, name, value, size, flags)
}
