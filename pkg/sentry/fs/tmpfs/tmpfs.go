...
func (d *Dir) SetXattr(ctx context.Context, i *fs.Inode, name, value string, size uint64, flags uint32) error {
	return d.ramfsDir.SetXattr(ctx, i, name, value, size, flags)
}
