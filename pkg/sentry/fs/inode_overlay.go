...
func overlayCreateWhiteout(ctx context.Context, parent *Inode, name string) error {
	return parent.InodeOperations.SetXattr(ctx, parent, XattrOverlayWhiteout(name), "y", 1, 0 /* flags */)
}
...
func overlaySetxattr(ctx context.Context, o *overlayEntry, name, value string, size uint64, flags uint32) error {
