...
func TestDistribution(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			[]endpointSockopts{
				endpointSockopts{0, 1},
				endpointSockopts{0, 2},
				endpointSockopts{0, 3},
			},
			map[tcpip.NICID][]float64{
		...
		},
		{
			...
			[]endpointSockopts{
				endpointSockopts{1, 1},
				endpointSockopts{1, 1},
				endpointSockopts{1, 2},
				endpointSockopts{1, 2},
				endpointSockopts{1, 2},
				endpointSockopts{1, 0},
			},
